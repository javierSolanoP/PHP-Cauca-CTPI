...
class ServiceSpecialityController extends Controller
{
    ...
    // Metodo para actualizar una especialidad de un servicio especifico: 
    public function update(Request $request, $service)
    {
        ...
        if(!empty('speciality_name')){
            ...
            if($contentValidateService['query']){
                ...
                if($contentValidateSpeciality['query']){
                    ...
                    if($validateServiceSpeciality){
                        ...
                        // Retornamos el error:
                        return response(content: ['register' => false, 'error' => 'No existe esa especialidad para ese servicio.'], status: 404);
                    }
            ...
            // Retornamos el error:
            return response(content: ['register' => false, 'error' => "Campo speciality_name: NO debe estar vacio."], status: 403);
        }
    ...
    public function destroy($service, $speciality)
    {
        ...
        if($contentValidateService['query']){
            ...
            // Validamos que existan especialidades asociadas al servicio: 
            if(count($validateServiceSpeciality) != 0){
                ...
                // Retornamos el error:
                return response(content: ['delete' => false, 'error' => 'No existen especialidades para ese servicio.'], status: 404);
            }
