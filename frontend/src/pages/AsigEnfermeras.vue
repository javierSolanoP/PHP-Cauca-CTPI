          ...
          <template slot="header">
            <div class="row">
              <div class="col-sm-6">
                ...
                <template>
                  <h2 class="card-title">Agregar Especialidad a Enfermeras</h2>
                </template>
              </div>
            </div>
          </template>
                ...
                <div class=" cardcol-sm-6 form">
                  <div class=" form-peice">
                    <form>
                      ...
                      <input placeholder="*" required type="text" v-model="form.identification" />
...
export default {
  ...
  methods: {
    guardar() {
      axios
        .post("http://127.0.0.1:8000/api/nurse-specialities/v1", this.form)
        .then((data) => {
          console.log(data);
          ...
          if (data.status === 201) {
            ...
            this.$router.push("/espenfermeras");
          } 
